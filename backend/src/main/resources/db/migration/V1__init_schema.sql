...
CREATE TABLE IF NOT EXISTS emotion_record (
    ...
    CONSTRAINT fk_emotion_record_user FOREIGN KEY (user_id) REFERENCES sys_user(id),
...
CREATE TABLE IF NOT EXISTS crisis_event (
    ...
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    handled_at DATETIME,
    CONSTRAINT fk_crisis_event_user FOREIGN KEY (user_id) REFERENCES sys_user(id),
